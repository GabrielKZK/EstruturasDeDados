...
class HeapSortAulaTest {
    ...
    HeapSortAula heapSort = new HeapSortAula();
    ...
    void testVetorPequeno() {
        ...
        int[] r11 = heapSort.ordenar(v11, "v11 (50 - Ordenado)");
        assertTrue(estaOrdenado(r11));

        int[] r12 = heapSort.ordenar(v12, "v12 (50 - Aleatório)");
        assertTrue(estaOrdenado(r12));

        int[] r13 = heapSort.ordenar(v13, "v13 (50 - Inverso)");
    ...
    void testVetorMedio() {
        ...
        int[] r21 = heapSort.ordenar(v21, "v21 (500 - Ordenado)");
        assertTrue(estaOrdenado(r21));

        int[] r22 = heapSort.ordenar(v22, "v22 (500 - Aleatório)");
        assertTrue(estaOrdenado(r22));

        int[] r23 = heapSort.ordenar(v23, "v23 (500 - Inverso)");
    ...
    void testVetorGrande() {
        ...
        int[] r31 = heapSort.ordenar(v31, "v31 (500000 - Ordenado)");
        assertTrue(estaOrdenado(r31));

        int[] r32 = heapSort.ordenar(v32, "v32 (500000 - Aleatório)");
        assertTrue(estaOrdenado(r32));

        int[] r33 = heapSort.ordenar(v33, "v33 (500000 - Inverso)");
